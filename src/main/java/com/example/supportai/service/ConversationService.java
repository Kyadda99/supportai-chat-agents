...
import com.example.supportai.tools.ConwersationLogger;
...
public class ConversationService
{
    ...
    private final ConwersationLogger logger;
    ...
    public ConversationService(RouterService routerService, TechnicalAgent technicalAgent, BillingAgent billingAgent, LlmClient llmClient, ConwersationLogger logger)
    {
    ...
    public ChatResponse handleMessage(String conversationId, String message)
    {
        ...
        history.add(new Message(anserw, agent));

        logger.log(conversationId, history);

        return new ChatResponse(conversationId,agent, anserw);
